...
admin.site.site_header = "ttee"
admin.site.site_title = "ttee Admin Portal"
admin.site.index_title = "ttee Admin"

# swagger
api_info = openapi.Info(
    title="ttee API",
    default_version="v1",
    description="API documentation for ttee App",
)
